...
import svc.CarInsertProService;
import vo.ActionForward;
import vo.CarVO;

public class CarInsertProAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		CarInsertProService carinsertproservice = new CarInsertProService();
		...
		isInsert = carinsertproservice.insertCar(carvo);
